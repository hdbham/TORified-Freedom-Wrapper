        ...
        bindService(new Intent(this, TorService.class), new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                if (conn != null) {
                    ...
                    webView.getSettings().setAllowContentAccess(true); // take a look at the documentation on the android studio developer page: https://developer.android.com/docs
                    webView.getSettings().setAllowFileAccess(true); // take a look at the documentation on the android studio developer page: https://developer.android.com/docs
                    webView.getSettings().setDomStorageEnabled(true); // take a look at the documentation on the android studio developer page: https://developer.android.com/docs
                    ...
                    webView.canGoBack();
                    webView.loadUrl("https://aidaccess.org"); //link to website you want to wrap
